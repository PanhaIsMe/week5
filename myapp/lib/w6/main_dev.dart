import 'package:myapp/w6/data/repositories/settings/settings_repository_mock.dart';
...
List<SingleChildWidget> get devProviders {
  return [
    ...
    ChangeNotifierProvider<AppSettingsState>(create: (_) => AppSettingsState(SettingRepositoryMock())..init()),
  ];
}
